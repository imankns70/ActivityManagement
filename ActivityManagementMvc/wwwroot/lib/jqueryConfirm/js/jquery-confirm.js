...
(function(factory){
    ...
    w.Jconfirm.prototype = {
        ...
        _parseColumnClass: function(colClass){
            ...
            switch(colClass){
                ...
                case 'l':
                case 'large':
                    p = 'col-lg-8 col-lg-offset-2';
                    break;
                case 'm':
                case 'medium':
                    p = 'col-lg-6 col-lg-offset-3';
                    break;
                case 's':
                case 'small':
                    p = 'col-lg-4 col-lg-offset-4';
                    break;
                case 'xs':
                case 'xsmall':
                    p = 'col-lg-2 col-lg-offset-5';
                    break;
                default:
                    p = colClass;
            }
    ...
    w.jconfirm.pluginDefaults = {
        ...
        watchInterval: 100,
        columnClass: 'col-lg-4 col-lg-offset-4 col-md-6 col-md-offset-3 col-sm-10 col-sm-offset-1',
        boxWidth: '40%',
