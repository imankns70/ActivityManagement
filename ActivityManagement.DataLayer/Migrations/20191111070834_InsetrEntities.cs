    ...
    public partial class InsetrEntities : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ActivityId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    TeamId = table.Column<int>(nullable: false),
                    TeamTitleId = table.Column<int>(nullable: false),
                    ...
                    SystemDate = table.Column<DateTime>(nullable: false, defaultValueSql: "CONVERT(datetime,GetDate())"),
                    ...
                    SupervisorDescription = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Activity_AppUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TeamSettingId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Title = table.Column<string>(nullable: true),
                    CheckSupervisor = table.Column<bool>(nullable: false),
                    UserId = table.Column<int>(nullable: false),
                    TeamId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeamSetting", x => x.TeamSettingId);
                    table.ForeignKey(
                        name: "FK_TeamSetting_Team_TeamId",
                        column: x => x.TeamId,
                        principalTable: "Team",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeamTitle", x => x.TeamTitleId);
                    table.ForeignKey(
                        name: "FK_TeamTitle_Team_TeamId",
                        column: x => x.TeamId,
                        principalTable: "Team",
                        principalColumn: "TeamId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserTeam_AppUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeamSetting_TeamId",
                table: "TeamSetting",
                column: "TeamId");

            migrationBuilder.CreateIndex(
                name: "IX_TeamTitle_TeamId",
                table: "TeamTitle",
                column: "TeamId");
